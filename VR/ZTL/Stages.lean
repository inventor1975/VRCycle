...
--
-- Axiom profile: `[]` throughout (measured at the bottom; guarded). The residual
-- `propext` of the Branch layer (Mathlib's list lemmas, noted 2026-07-12) was repaid on
-- 2026-09-12 with the hand-rolled lemmas of `Continuum/ListCore.lean`.
