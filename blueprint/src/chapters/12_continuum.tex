...
\texttt{VRClassical/Continuum/Spectrum.lean} certifies it at build time over the generic
...
The Lean~4 formalisation lives under \texttt{VR/Continuum/} (\texttt{Rational},
...
with the meta-thesis in \texttt{VRClassical/Meta/DoingNotBeing.lean}.
